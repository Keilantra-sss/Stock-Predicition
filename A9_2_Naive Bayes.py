...
# Perform Gaussian naive bayesian classifier
NB_classifier = GaussianNB().fit(X,y)
y_pred = NB_classifier.predict(X2)
...
print('For the trading strategy using naive bayes, the final amount is $',round(value_new,2))

# Comparison
if value_new > value:
    print('The naive bayes results in a larger amount at the end of the year.')
